...
set :wp_user, ENV['USER'] # The admin username
set :wp_email, "#{ENV['USER']}@example.com" # The admin email address
set :wp_sitename, "WP Deploy Sample" # The site title
...
set :application, "wp-deploy-sample"
set :repo_url, "git@github.com:haracane/wp-deploy-sample.git"
set :scm, :git
